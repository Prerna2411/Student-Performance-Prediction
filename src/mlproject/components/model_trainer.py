...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            if not model_report:
                raise CustomException("Model evaluation failed: No valid model found.")
            ...
            # Save the model even if it is below 0.6 R²
            if best_model_score < 0.6:
                print("Warning: No model found with R² > 0.6, saving the best available model.")
            ...
            print(f"Model R² score: {r2_square}")
